...
#define LCD_RST_Clr() HAL_GPIO_WritePin(GPIOD, RST_Pin, GPIO_PIN_RESET)
#define LCD_RST_Set() HAL_GPIO_WritePin(GPIOD, RST_Pin, GPIO_PIN_SET)
...
#define LCD_BL_Clr() HAL_GPIO_WritePin(GPIOD, BL_Pin, GPIO_PIN_RESET)
#define LCD_BL_Set() HAL_GPIO_WritePin(GPIOD, BL_Pin, GPIO_PIN_SET)
